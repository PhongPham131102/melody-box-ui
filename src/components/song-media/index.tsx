...
const SongMedia: React.FC<SongMediaProps> = ({
  imageIcon,
  title,
  artists,
  playIcon = _playIcon,
  ...
  return (
    <div className="group hover:bg-secondary-1 w-full py-4 px-2 gap-2 flex items-center transition-all duration-150  rounded cursor-pointer">
